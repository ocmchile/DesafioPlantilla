...
jQuery(document).ready(function() {
    ...
    */
    $.backstretch([
                  ...
                  // "<%= asset_path('/img/backgrounds/1.jpg') %>",
                  // "<%= asset_path('/img/backgrounds/1.jpg') %>",
                  "/vendor/assets/assetsTrilli/img/backgrounds/1.jpg",
                  "<%= asset_path('/img/backgrounds/2.jpg') %>",
                  "<%= asset_path('/assets/img/backgrounds/3.jpg') %>"
